...
cartStore.onAddProductToCart(1);
cartStore.onAddProductToCart(12);
cartStore.onAddProductToCart(11);
cartStore.onAddProductToCart(1);
cartStore.onAddProductToCart(2);
cartStore.onAddProductToCart(1);

describe('cart', () => { 
    it('should render', () => {
      const { queryAllByText,debug } = render(<CartItems/>)
      const quant=queryAllByText(/Quatity/)
      
      expect(quant).toHaveLength(4)
